...
impl WorldState {
    pub fn new() -> Self {
        // Initialize Advisors
        let advisors = vec![
            Advisor { name: "Gen. Vance".to_string(), role: AdvisorRole::General, suspicion: 0, is_mole: false },
            Advisor { name: "Director K.".to_string(), role: AdvisorRole::Director, suspicion: 0, is_mole: false },
            Advisor { name: "Amb. Sterling".to_string(), role: AdvisorRole::Ambassador, suspicion: 0, is_mole: false },
        ];
